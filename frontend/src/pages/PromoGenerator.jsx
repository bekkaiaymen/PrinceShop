...
function PromoGenerator() {
  ...
  useEffect(() => {
    ...
    const initMap = () => {
      ...
      try {
        ...
        map.addListener('dragend', () => {
          ...
          // تأكيد الموقع تلقائياً عند التحريك
    ...
    let attempts = 0;
    const maxAttempts = 150; // زيادة عدد المحاولات إلى 150
    ...
    const tryInit = () => {
      ...
      if (window.google && window.google.maps && mapContainerRef.current) {
        ...
        // زيادة وقت الانتظار تدريجياً لتقليل الضغط
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          // تأكيد الموقع تلقائياً عند الحصول على الموقع الحالي
          setLocationConfirmed(true);
        },
        (error) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // تم إزالة شرط تأكيد الموقع للسماح بإرسال الطلب بدونه
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-3 bg-gray-50 border-2 border-gray-300 rounded-xl p-4">
                  ...
                  {/* زر تأكيد الموقع تمت إزالته ليصبح التأكيد تلقائياً */}
