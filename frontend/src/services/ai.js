...
7️⃣ **دقة ذكية (المرونة في التطابق)**:
   - طابق **المفهوم** وليس الكلمات فقط.
   - "سماعة" == "Airpods" (هذا تطابق صحيح 100%)
   - "ساعة" == "Smart Watch" (صحيح)
   - تجاهل الأخطاء الإملائية البسيطة (سماعه/سماعة).
   - لا تضف منتجات من فئة مختلفة تماماً (مثلاً لا تضف شواحن إذا طلب سماعات).

🎯 المطلوب منك:
1. حلل الاستعلام بعمق.
2. اعتبر المنتجات المكتوبة بالإنجليزية/الفرنسية أهدافاً صالحة للاستعلام العربي.
3. أعد أرقام المنتجات التي تلبي حاجة العميل فعلياً.
...
⚠️ تذكر: كن ذكياً في الربط، لا تكن حرفياً جداً.`;
